...
RUN apt update
RUN apt install -y curl wget unzip fonts-noto locales fontconfig locales-all fonts-noto libnss3-dev libxss1 libasound2 libxrandr2 libatk1.0-0 libgtk-3-0 libgbm-dev libxshmfence1
